...
import static com.magnetocandidato.userinterfaces.RegisterBronze.BUTTON_NEXT;
import static com.magnetocandidato.utils.Contant.*;
import static net.serenitybdd.screenplay.Tasks.instrumented;

public class RegisterUserDiamond implements Task {
    private int code;
    private int code2;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
               ...
               // Click.on(SELECT_CATEGORIES),
                ...
                Click.on(BUTTON_CONTINUE_REGISTER_FINAL),//DIAMANTE
    ...
    public static RegisterUserDiamond registerDiamond() {return instrumented(RegisterUserDiamond.class);
    }
}
